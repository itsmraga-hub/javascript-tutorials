...
function sumOfArray(n, a, b) {
    let sumOfAnArray = 0
    for (let i = 1; i <= n; i++) {
        sumOfAnArray += i
    }
    // console.log(sumOfAnArray)
    return [sumOfAnArray, a, b]
}
...
// sumOfArray(1000)
// sumOfArray(10000)
console.log("Sum of numbers from 1 to 10 is", sumOfArray(10, 3, 2))


//parameters - Passed during function definition
